...
CANDIDATES = [
    ...
    (
        ...
        "Масштаб по геопроекции (валидирована на рюкзаке, ±15 м): дрон висел в 15–60 м от склона, "
    ...
    (
        ...
        [
            ...
            dict(video="DJI_20260813183727_0015_Z", tc="3:00–3:08", conf=4,
                 desc="Ярко-оранжевый мягкий предмет (~15–20 см; ткань/перчатка?) на осыпи. "
                      "Геопроекция: объект 39.483595, 73.585515, ~4548 м, снят с 11 м — координата "
                      "точная. Отдельный от большого оранжевого (в ~35 м от него)",
    ...
    (
        "Оранжевые предметы — атрибуция скрина «Вещи #1721»: минимум два",
        "Решено геопроекцией (analysis/review/geoprojection.md; метод валидирован на рюкзаке ±15 м). "
        "Большой (~2–3 м, ткань/чехол/тент?) — 39.48325–39.48331, 73.58509–73.58518, ~4558 м, "
        "в 10–15 м от подтверждённого стакана; рядом с ним отдельный мелкий фрагмент ~0,2 м. "
        "Малый (~15–20 см) — 39.483595, 73.585515, ~4548 м, в ~35 м северо-восточнее (см. секцию выше).",
        [
